...
ps_motor_controller_ns = cg.esphome_ns.namespace('ps_motor_controller')
PSMotorControllerComponent = ps_motor_controller_ns.class_('PSMotorControllerComponent', cg.Component, spi.SPIDevice)
...
CONFIG_SCHEMA = cv.COMPONENT_SCHEMA.extend({
    cv.GenerateID(): cv.declare_id(PSMotorControllerComponent)
